...
module "vpc" {
  ...
  vpc_cidr           = "10.248.184.0/21"
  public_subnets     = ["10.248.190.0/24", "10.248.191.0/24"]
  private_subnets    = ["10.248.184.0/23", "10.248.186.0/23"]
...
module "certificates" {
  ...
  environment               = local.environment
  domain                    = "reecedev.us"
  subject_alternative_names = ["*.reecedev.us", "*.external-test.reecedev.us"]
}
...
module "cloudfront" {
  ...
  max_portal_lb_arn = "arn:aws:elasticloadbalancing:us-east-1:666210046287:loadbalancer/app/k8s-default-external-905333b6c2/2df4f8646ed8e1a1"
...
module "bastion" {
  ...
  contact_emails             = local.contact_emails
  bastion_key_pair_name      = "bastion_test"
...
module "iam-service-accounts" {
  ...
  post_api_k8s_service_account = "system:serviceaccount:default:external-test-post-api-service"
}
...
module "route53" {
  ...
  lb_arn_max_api         = "arn:aws:elasticloadbalancing:us-east-1:666210046287:loadbalancer/app/k8s-default-external-ad55c978ba/f15f0e137fd652c2"
  lb_arn_mobile_bff      = "arn:aws:elasticloadbalancing:us-east-1:666210046287:loadbalancer/app/k8s-default-external-93696e305b/6cea27f40f0b1f23"
  lb_grafana_name        = "ae203e368349c425f828f7cb6305b42e-87565417.us-east-1.elb.amazonaws.com"
...
module "product_data_etl" {
  ...
  s3_bucket_name                  = "external-snowflake-etl-extract"
  s3_bucket_name_mincron          = "external-mincron-etl-extract"
  s3_bucket_name_bk               = "external-bath-kitchen-etl-extract"
  s3_bucket_name_lambda_deps      = "external-etl-lambda-deps"
  private_subnets                 = module.vpc.private_subnets
  vpc_id                          = module.vpc.id
}
