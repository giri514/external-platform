...
module "vpc" {
  ...
  vpc_cidr           = "10.248.208.0/21"
  public_subnets     = ["10.248.214.0/24", "10.248.215.0/24"]
  private_subnets    = ["10.248.208.0/23", "10.248.210.0/23"]
...
module "certificates" {
  ...
  environment               = local.environment
  domain                    = "reecedev.us"
  subject_alternative_names = ["*.reecedev.us", "*.external-stage.reecedev.us"]
}
...
module "cloudfront" {
  ...
  max_portal_lb_arn = "arn:aws:elasticloadbalancing:us-east-1:579551996060:loadbalancer/app/k8s-default-external-949216fd9f/4780b59e527c77e2"
...
module "iam-service-accounts" {
  ...
  post_api_k8s_service_account = "system:serviceaccount:default:external-stage-post-api-service"
}
...
module "route53" {
  ...
  lb_arn_max_api         = "arn:aws:elasticloadbalancing:us-east-1:579551996060:loadbalancer/app/k8s-default-external-ee481601cd/618e935a65083714"
  lb_arn_mobile_bff      = "arn:aws:elasticloadbalancing:us-east-1:579551996060:loadbalancer/app/k8s-default-external-2efa74c66b/c112520f941f7a3b"
  lb_grafana_name        = "a95053601c9a6428f8a9c4114d548306-96827764.us-east-1.elb.amazonaws.com"
