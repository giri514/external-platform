...
module "vpc" {
  ...
  vpc_cidr           = "10.248.176.0/21"
  public_subnets     = ["10.248.182.0/24", "10.248.183.0/24"]
  private_subnets    = ["10.248.176.0/23", "10.248.178.0/23"]
...
module "cloudfront" {
  ...
  max_portal_lb_arn = "arn:aws:elasticloadbalancing:us-east-1:295627748739:loadbalancer/app/k8s-default-external-4aea8fc9ce/b4dde4e642ecc919"
  alternate_domain_names = [
    ...
    "reecebathandkitchen.external-${local.environment}.reecedev.us",
...
module "bastion" {
  ...
  contact_emails             = local.contact_emails
  bastion_key_pair_name      = "bastion_dev"
...
module "iam-service-accounts" {
  ...
  post_api_k8s_service_account = "system:serviceaccount:default:external-dev-post-api-service"
}
...
module "route53" {
  ...
  lb_arn_max_api         = "arn:aws:elasticloadbalancing:us-east-1:295627748739:loadbalancer/app/k8s-default-external-a1abcbfe4e/2582dfdddc751a49"
  lb_arn_mobile_bff      = "arn:aws:elasticloadbalancing:us-east-1:295627748739:loadbalancer/app/k8s-default-external-eb45ac17f6/081e5582933ba7e2"
  lb_grafana_name        = "abae44d87e5e347c1ad66f1c0b724662-483570408.us-east-1.elb.amazonaws.com"
